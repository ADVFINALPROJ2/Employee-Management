...
export default function AddEmployee() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 bg-opacity-40 flex items-center justify-center p-4 antialiased">
      <div className="w-full max-w-xl bg-white rounded-sm shadow-2xl overflow-hidden border border-gray-100">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
          ...
          <div>
            ...
            <div className="relative flex items-center">
              ...
              <input
                ...
                onChange={handleChange}
                className="w-full pl-10 pr-3 py-2 bg-gray-50 text-gray-800 border border-gray-200 rounded-md text-sm focus:outline-none focus:bg-white focus:ring-1 focus:ring-blue-400 transition-colors"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-1">City/State</label>
              <div className="relative flex items-center">
                <span className="absolute left-3 text-gray-400">📍</span>
                <input
                  name="city"
